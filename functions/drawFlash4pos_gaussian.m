...
%
% synopsis
% outIm = drawFlash4pos_gaussian(inX,inY,contrast,radius,bslCol, nAngles)
%
%
...
% newPosQuad: one of the four quadrants to  display flash
%
%##########################################################################
%
...
function [outIm, cntX, cntY]= drawFlash4pos_gaussian(inX,inY,contrast,radius,bslCol, nAngles,newPosQuad)
...
%     legend('theoretical','effective')
    ...
    cntX = inX/2+newPosQuad(2);
    cntY = inY/2+newPosQuad(1);
